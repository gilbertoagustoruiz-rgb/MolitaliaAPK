...
Las correcciones administrativas de una venta deben actualizar su marca temporal y los upserts posteriores deben respetar “última actualización gana”; de lo contrario, una copia antigua puede revertir fecha, importe o comentario.

Las ventas nuevas necesitan identificadores globalmente únicos y la sincronización de clientes debe unir ventas pendientes con el snapshot completo del servidor; un contador local puede colisionar entre dispositivos y convertir una venta nueva en una actualización.