...
**How to apply:** Mantener localStorage como cola offline, fusionar por identificador en el servidor, serializar las escrituras y reintentar cuando el navegador recupere conexión.