...
import { Camera, Check, CheckCircle2, Clock3, Download, FileSpreadsheet, Gift, LogOut, MapPin, Moon, PackageCheck, Pencil, Plus, RefreshCw, Search, ShieldCheck, ShoppingBag, Smartphone, Store, Sun, Trash2, Upload, UserRound, Users, WifiOff, X } from 'lucide-react';
  ...
  const saveSale = () => {
    ...
    const finalizeAttendance = (tastingUsed = 0) => {
     ...
     if (type === 'SALIDA') {
      ...
      setMarkPhoto(null); setMarkType(type === 'ENTRADA' ? 'SALIDA' : 'ENTRADA'); setView('LISTA'); notify(type === 'SALIDA' ? 'Salida registrada correctamente. Sesión finalizada.' : 'Entrada registrada correctamente');
