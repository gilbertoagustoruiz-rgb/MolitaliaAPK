      ...
      : planchas === 10
        ...
        : planchas === 4
          ...
          : planchas === 1
            ...
            : undefined;
  if (mode === 'PLANCHAS' && (planchas === 10 || planchas > 80)) return canjeProducts.find(product => product.id === productId)?.label;
